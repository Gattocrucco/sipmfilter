...
commands = [
    '-m 100000 -L 1 darksidehd/nuvhd_lf_3x_tile57_77K_64V_6VoV_1.wav',
    '-m 100000 -L 1 -t -l 500 darksidehd/nuvhd_lf_3x_tile57_77K_64V_6VoV_1.wav',
]
...
for ifile, cmd in enumerate(commands):
    ...
    figname = f'fighist2dtile57-{ifile}'
